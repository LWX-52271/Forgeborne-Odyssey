...
public class StoneArrowModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(ForgeborneOdyssey.MOD_ID, "stone_arrow"), "main");

    private final ModelPart bb_main;

    public StoneArrowModel(ModelPart root) {
