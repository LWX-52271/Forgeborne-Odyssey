...
public class DryingRecipeCategory implements IRecipeCategory<DryingRecipe> {
    ...
    public static final RecipeType<DryingRecipe> RECIPE_TYPE =
            RecipeType.create(ForgeborneOdyssey.MOD_ID, "drying", DryingRecipe.class);
    ...
    public DryingRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.localizedName = Component.translatable("jei.forgeborneodyssey.drying");
    }
    ...
    public void draw(DryingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics,
        ...
        int seconds = recipe.getDryingTime() / 20;
