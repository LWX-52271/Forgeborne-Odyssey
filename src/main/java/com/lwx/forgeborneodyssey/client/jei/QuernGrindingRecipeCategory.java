...
public class QuernGrindingRecipeCategory implements IRecipeCategory<QuernGrindingRecipe> {

    public static final RecipeType<QuernGrindingRecipe> RECIPE_TYPE =
            RecipeType.create(ForgeborneOdyssey.MOD_ID, "quern_grinding", QuernGrindingRecipe.class);
    ...
    public QuernGrindingRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.localizedName = Component.translatable("jei.forgeborneodyssey.quern_grinding");
    }

    @Override
    public RecipeType<QuernGrindingRecipe> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    @Override
    public void draw(QuernGrindingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics,
